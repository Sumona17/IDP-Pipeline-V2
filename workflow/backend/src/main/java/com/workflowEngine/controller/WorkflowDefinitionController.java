...
public class WorkflowDefinitionController {
    ...
    public WorkflowDefinition updateWorkflow(@PathVariable String workflowId, @RequestBody SaveWorkflowRequest request){
        WorkflowDefinition updated =
                service.updateWorkflow(workflowId, request);
