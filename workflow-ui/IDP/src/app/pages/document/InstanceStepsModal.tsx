...
export const InstanceStepsModal: React.FC<InstanceStepsModalProps> = ({
  ...
  const [showRawPayloadByStep, setShowRawPayloadByStep] = React.useState<
              ...
              <div className="space-y-4">
                {sortedSteps.map((step) => {
                  ...
                  const isDocumentReview =
                    ...
                    step.nodeName === "DOCUMENT_REVIEW_APPROVAL";
                  const isDocumentClassifier =
                    step.nodeName === "DOCUMENT_CLASSIFIER";
                                      ...
                                      <div className="rounded-xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-3">
                                        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                                          ...
                                          <div className="rounded-lg border border-slate-200 bg-white px-3 py-3 shadow-sm">
                                            ...
                                            <div className="mt-1 text-sm font-semibold text-slate-900">
                                              {
                                                documentClassifierData.formType
                                                  .description
                                              }
                                            </div>
                                          </div>
